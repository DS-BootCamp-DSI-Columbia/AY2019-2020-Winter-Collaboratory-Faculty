...
* If you need to find a research assistant with experience in Stan or a collaborator for a grant
  application involving Stan, contact me (benjamin.goodrich@columbia.edu), Andrew Gelman
  (gelman@stat.columbia.edu), or one of the other Stan developers at Columbia
